    ...
    ui(new Ui::setting_manageuser)
{
    ...
    model->setItem(0, 4, new QStandardItem("13094703@qq.com"));
    model->setItem(0, 5, new QStandardItem("2020-7-16"));
    ...
    model->setItem(1, 5, new QStandardItem("2020-7-16"));
    ...
    model->setItem(2, 5, new QStandardItem("2020-7-17"));
    ...
    model->setItem(3, 5, new QStandardItem("2020-7-18"));
